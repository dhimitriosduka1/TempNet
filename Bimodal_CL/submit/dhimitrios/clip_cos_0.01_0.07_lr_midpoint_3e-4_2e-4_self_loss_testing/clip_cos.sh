...
DESC=CLIP_COS_${TAU_MIN}_${TAU_MAX}_LR_MINDPOINT_${LR_START}_${LR_END}_SL_TESTING
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 -m torch.distributed.launch --nproc_per_node=4 --master_port=4821 \
    ...
    --data_path $DATA_PATH \
    --data $DATA \
    --output_dir /BS/dduka/work/projects/TempNet/Bimodal_CL/submit/dhimitrios/clip_cos_0.01_0.07_lr_midpoint_3e-4_2e-4_self_loss_testing/ \
    --init_model \
    --use_amp \
    --epochs 30 --lr $LR \
    --ita_type clip \
